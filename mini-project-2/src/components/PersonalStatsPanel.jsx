...
function PersonalStatsPanel({ onStatsChange, onPrayersChange, onStyleChange }) {
    ...
    function handleStyleChange(activeStyle) {
        onStyleChange && onStyleChange(activeStyle);
    }
        ...
        <Container className="p-3 mb-1">
            <Tabs defaultActiveKey="TAB_KEYS.STATS" id="uncontrolled-tab" className="mb-3">
                ...
                <Tab eventKey={"TAB_KEYS.STYLE"} title={<Image src="/icons/Combat_icon.png" />}>
                    <Card.Title className="mb-2">Attack Style</Card.Title>
                    <AttackStyleSelector onStyleChange={handleStyleChange} />
                </Tab>
            </Tabs>
        </Container>
    );
